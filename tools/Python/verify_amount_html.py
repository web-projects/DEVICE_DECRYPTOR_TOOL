...
def htmlEntry():
    ...
    #html_resource = b'mapp/request_choice_numeric.html'
    #html_resource = b'verify_amount.html'
    ...
    #  [(0xDF, 0xAA, 0x02), b'title'], [(0xDF, 0xAA, 0x03), b'VERIFY AMOUNT'],
      
    #  [(0xDF, 0xAA, 0x01), html_resource],
    #  [(0xDF, 0xAA, 0x02), b'title'], [(0xDF, 0xAA, 0x03), b'1. YES'],
  
    #  [(0xDF, 0xAA, 0x01), html_resource],
    #  [(0xDF, 0xAA, 0x02), b'title'], [(0xDF, 0xAA, 0x03), b'2. NO']
    #]
