...
namespace DeviceDecryptorTool.Config
{
    internal static class SetupEnvironment
    {
        ...
        private static void SetWorkingDirectories()
        {
            string fullName = Assembly.GetEntryAssembly().Location;
            string path = Directory.GetCurrentDirectory();
        ...
        public static TVPAttributes ParseArguments(string[] args)
        {
            TVPAttributes tvpAttributes = new TVPAttributes();
