...
namespace Decryptors.DUPKT
{
    public static class Dukpt
    {
        ...
        private static BigInteger CreateSessionKey(string bdk, string ksn, DUKPTVariant DUKPTVariant)
        {
            ...
            Debug.WriteLine(string.Format("PEK_: {0}", ConversionHelper.ByteArrayToHexString(BigIntegerExtensions.GetBytes(ipek))));
            ...
            Debug.WriteLine(string.Format("KEY_: {0}", ConversionHelper.ByteArrayToHexString(BigIntegerExtensions.GetBytes(sessionKey))));
        ...
        public static byte[] Decrypt(string bdk, string ksn, byte[] encryptedData, DUKPTVariant variant)
        {
            ...
            Debug.WriteLine(string.Format("DATA: {0}", ConversionHelper.ByteArrayToHexString(encryptedData)));
