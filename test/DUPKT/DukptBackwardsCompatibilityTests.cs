...
namespace DeviceDecryptorTool.DukptNet.Test
{
    ...
    public class DukptBackwardsCompatibilityTest
    {
        ...
        public void TestDecryption()
        {
            ...
            var decBytes = Dukpt.Decrypt(bdk, ksn, ConversionHelper.HexToByteArray(track));
        ...
        public void TestIdTechDecryption()
        {
            ...
            var decBytes = Dukpt.DecryptIdTech(bdk, ksn, ConversionHelper.HexToByteArray(track));
